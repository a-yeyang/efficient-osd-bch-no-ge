...
from work_paths import WORK_ROOT, FIGURES_DIR, TABLES_DIR
...
t1 = json.loads((TABLES_DIR / "table_I.json").read_text())
t3 = json.loads((TABLES_DIR / "table_III.json").read_text())
t4 = json.loads((TABLES_DIR / "table_IV.json").read_text())
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "latency_bars.png", dpi=140)
plt.savefig(FIGURES_DIR / "latency_bars.pdf")
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "latency_vs_snr.png", dpi=140)
plt.savefig(FIGURES_DIR / "latency_vs_snr.pdf")
